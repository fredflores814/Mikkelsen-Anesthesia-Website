...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ErikMikkelsen@mikkelsenanesthesia.com'  # Your email address
EMAIL_HOST_PASSWORD = 'ahdo ihar dqcp iiha'  # Your email password

# Default from email address
DEFAULT_FROM_EMAIL = 'ErikMikkelsen@mikkelsenanesthesia.com'  # Replace with your Gmail address

# Contact email for receiving consultation requests
CONTACT_EMAIL = 'ErikMikkelsen@mikkelsenanesthesia.com'  # Email where consultation requests are sent
...
AUTHORIZE_NET_ENVIRONMENT = os.environ.get('AUTHORIZE_NET_ENVIRONMENT', 'production')  # 'sandbox' or 'production'
